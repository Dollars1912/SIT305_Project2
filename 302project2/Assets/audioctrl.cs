...
public class audioctrl : MonoBehaviour {
    ...
    /// these method will been called wherever the user change the settings of the game.(exp: user turn on and turn off the sounds orr change the volume of the sounds)
